import"./script-CWrZfDU4.js";const n="https://ceramic-api.onrender.com";async function l(){const e=`${n}/api/posts`;return(await fetch(e,{headers:{Accept:"application/json"}})).json()}function a(e){const o=document.querySelector(".blog_feed-container");o&&(o.innerHTML="",e.forEach(t=>{o.insertAdjacentHTML("beforeend",`
